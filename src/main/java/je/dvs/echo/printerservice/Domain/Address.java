package je.dvs.echo.printerservice.Domain;import org.springframework.stereotype.Component;@Component
public class Address {    public String departmentName;
    public String subDepartmentName;
    public String street;
    public String parish;
    public String island;
    public String postcode;    public Address() {
